function fDataProcessing(sParafile, sModel, lPats, iGPU)
% inputs
...
% database
if(ispc)
    sPath = 'F:\Courses\INFOTECH\MasterThesis\newProtocol';    
else
...
[sData,sPathOut] = fGetModelInfo( sModel );

if(ischar(sData.Head))
	sData.Head = {sData.Head;0};
end
if(ischar(sData.Head_m))
	sData.Head_m = {sData.Head_m;1};
end
if(ischar(sData.Becken_t1))
	sData.Becken_t1 = {sData.Becken_t1;2};
end
if(ischar(sData.Becken_m))
	sData.Becken_m = {sData.Becken_m;3};
end
if(ischar(sData.Becken_t2))
	sData.Becken_t2 = {sData.Becken_t2;4};
end
if(ischar(sData.Becken_s))
	sData.Becken_s = {sData.Becken_s;5};
end
if(ischar(sData.Liver_t1))
	sData.Liver_t1 = {sData.Liver_t1;6};
end
if(ischar(sData.Liver_m))
	sData.Liver_m = {sData.Liver_m;7};
end
if(ischar(sData.Liver_t2))
	sData.Liver_t2 = {sData.Liver_t2;8};
end
if(ischar(sData.Liver_s))
	sData.Liver_s = {sData.Liver_s;9};
end

sDataAll = cat(2,sData.Head,sData.Head_m,sData.Becken_t1,sData.Becken_m,sData.Becken_t2,sData.Becken_s,sData.Liver_t1,sData.Liver_m,sData.Liver_t2,sData.Liver_s);
